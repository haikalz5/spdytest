    ...
    <div class="card o-hidden shadow-lg">
        <div class="card-body p-5">
            <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Welcome to Spdy Parcel!</h1>
            </div>
            <form>
                ...
                <a href="orders.html" class="btn btn-primary btn-user btn-block">Login</a>
            </form>
            <hr>
            <div class="text-center">
            ...
            <div class="text-center">
                <a class="small text-light" href="#">Create an Account!</a>
            </div>
        </div>
    </div>
</body>
